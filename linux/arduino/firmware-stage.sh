...
cp /opt/orange/arduino/OpenROV/* $BUILDDIR/src || error_exit "Copying files from the github src folder to the temp folder failed.  Aborting"
echo staged src in to build folder 1>&2

echo --------------------- 1>&2
echo staging plugins 1>&2
SEARCHPATH=/opt/orange/cockpit/
